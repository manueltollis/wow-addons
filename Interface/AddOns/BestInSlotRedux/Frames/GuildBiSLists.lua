...
=     GetGuildInfo, C_Item.GetItemInfo, GetItemInfoFromHyperlink, C_Item.GetItemIconByID, GetOSLocale, GetNumSpecializationsForClassID, GetSpecializationInfoForClassID, GetInventorySlotInfo, IsInGuild, CreateFrame, StaticPopup_Show, EasyMenu
