...
L["Automatically pick Whirling Surge/Lightning Surge the first time you log in on a character."] = "第一次登录角色时自动选择回旋急冲/奔雷疾冲。"
L["Automatically purchases the Skyriding talent when you have enough currency."] = "当你拥有足够的货币时自动学习驭空术的天赋。"
...
L["Skyriding Auto Purchaser"] = "驭空术天赋自动学习"
L["Spell Icon"] = "法术图标"
L["Spell ID"] = "法术 ID"
