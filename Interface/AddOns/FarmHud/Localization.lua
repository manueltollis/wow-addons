...
L["AddOnLoadedDesc"] = "Mostrar el mensaje «AddOn Cargado...» al iniciar sesión y recargar la interfaz de usuario."
L["AddOnLoadedDescAlt"] = "También puede mantener pulsada la tecla Mayús en la pantalla de carga para que aparezca este mensaje sólo para este inicio de sesión."
L["AnotherAddOnsHijackedFunc"] = "Advertencia: Otro addon ha secuestrado algunas funciones esenciales. Consulte la siguiente lista:"
L["BgTransparency"] = "Transparencia de fondo"
L["Black player dot"] = "Punto de jugador negro"
L["Blizzards player arrow"] = "Flecha de jugador de Blizzards"
L["Blizzards player arrow (smaller)"] = "Flecha de jugador de Blizzards (más pequeña)"
L["CardinalPoints"] = "Puntos cardinales"
L["CardinalPointsColorDesc"] = "Ajustar el color de puntos cardinales (%s)"
L["CardinalPointsColorResetDesc"] = "Restablecer el color de los puntos cardinales (%s)"
L["CardinalPointsGroup1"] = "Puntos cardinales grupo 1 (Abreviaturas de Norte, Oeste, Sur, Este)"
L["CardinalPointsGroup2"] = "Puntos cardinales grupo 1 (abreviaturas de noroeste, noreste, suroeste y sureste)"
L["CardinalPointsShow"] = "Mostrar puntos cardinales"
L["CardinalPointsShowDesc"] = "Mostrar los puntos cardinales en el HUD"
...
L["CoordsBottom"] = "Coordenadas parte inferior"
L["CoordsBottomDesc"] = "Mostrar las coordenadas del jugador en la parte inferior"
L["CoordsColorDesc"] = "Ajustar el color de coordenadas"
L["CoordsColorResetDesc"] = "Restablecer el color de las coordenadas"
L["CoordsShow"] = "Mostrar coordenadas"
L["CoordsShowDesc"] = "Mostrar las coordenadas del jugador en el HUD"
L["DataBrokerOptions"] = "para abrir las opciones FarmHud"
L["DataBrokerToggle"] = "para alternar FarmHud"
L["DataBrokerToggleBackground"] = "para alternar el fondo del minimapa"
L["DebugOptFrames"] = "Lista de elementos no deseados"
L["DebugOptFramesDesc"] = "Muestra una lista de los elementos no deseados anclados en el Minimapa si FarmHud está activado."
L["DebugOptInfo"] = "Esta sección contiene opciones para ayudar a rastrear problemas con otros addons."
L["E"] = "Versión abreviada del punto cardinal \"Este\""
L["ExtraAddOnLoaded"] = "¡El addon extra '%s' está activado!"
L["ExtraAddOnNotLoaded"] = "El complemento extra '%s' debe estar activado para esta opción."
L["GatherCircle"] = "Círculo de recolección"
L["GatherCircleColorDesc"] = "Ajustar el color del círculo"
L["GatherCircleDesc"] = "El círculo es una línea de ayuda visual. Representa la distancia alrededor de tu posición en la que todos los puntos de interés (buzón, mineral, hierba) aparecerán en el minimapa y en FarmHud."
L["GatherCircleShow"] = "Mostrar círculo de recolección"
L["GatherCircleShowDesc"] = "Mostrar el círculo de recolección en el HUD"
L["Golden player dot"] = "Punto jugador dorado"
L["HealCircle"] = "Círculo de rango de curación"
L["HealcircleColorDesc"] = "Ajusta el color del círculo del rango de curación"
L["HealcircleDesc"] = "El círculo de alcance de curación es una línea de ayuda visual. Representa la distancia máxima a tu posición en la que puedes curar a otros jugadores."
L["HealcircleShow"] = "Mostrar círculo de rango de curación"
L["HealcircleShowDesc"] = "Mostrar el círculo de alcance de curación en el HUD"
L["Hide player arrow"] = "Ocultar la flecha del jugador"
L["HudSize"] = "Tamaño del HUD"
L["HudSizeDesc"] = "Establece el tamaño del HUD en un porcentaje de la altura de la pantalla"
L["HudSymbolScale"] = "Escala de los símbolos HUD"
L["HudSymbolScaleDesc"] = "Escala el tamaño de los símbolos en el HUD"
L["KeyBindBackground"] = "Alternar el fondo del minimapa de FarmHud"
L["KeyBindBackgroundDesc"] = "Establece un atajo en el teclado para mostrar el fondo del minimapa."
L["KeyBindMouse"] = "Alterna ayuda emergente de FarmHud (No se puede hacer clic atreves de Hud)"
L["KeyBindMouseDesc"] = "Establecer un atajo en el teclado para permitir que el ratón pase por encima de los detalles de los nodos de puntos de interés (como mineral, hierba o buscador). O para hacer clic en el hud para enviar un ping a su grupo o raid."
L["KeyBindToggle"] = "Alternar la pantalla de FarmHud"
L["KeyBindToggleDesc"] = "Establecer un atajo de teclado para mostrar FarmHud."
L["KnownProblematicAddOnDetected"] = "ADVERTENCIA: está utilizando un addon que dificulta una cooperación fluida con FarmHud. Posible solución: Puede intentar ocultar los elementos molestos. Desactiva «Mostrar elementos» en las opciones de FarmHud."
L["MinimapIcon"] = "Icono en minimapa"
L["MinimapIconDesc"] = "Mostrar el icono en minimapa."
L["MouseOn"] = "CURSOR ACTIVO"
L["MouseOver"] = "Sobre Cursor"
L["MouseOverInfoColorDesc"] = "Ajustar el color del texto 'MOUSE ACTIVO' en el HUD"
L["MouseOverOnHold"] = "Pasar el ratón por encima al mantener pulsada una tecla adicional"
L["MouseOverOnHoldDesc"] = "Esta opción es para activar el 'sobre cursor' mientras mantienes pulsada una tecla como el Alt"
L["N"] = "Versión abreviada del punto cardinal \"Norte\""
L["NE"] = "Versión abreviada del punto cardinal \"Noreste\""
L["NW"] = "Versión abreviada del punto cardinal \"Noroeste\""
L["OnScreen"] = "Botones en pantalla"
L["OnScreenAlphaDesc"] = "Ajuste la transparencia de los botones en pantalla"
L["OnScreenBottom"] = "Botones en la pantalla parte inferior"
L["OnScreenBottomDesc"] = "Mostrar los botones de la pantalla parte inferior del centro del HUD"
L["OnScreenShow"] = "Mostrar los botones en pantalla"
L["OnScreenShowDesc"] = "Mostrar botones en pantalla (modo \"ratón activo\", botón de cierre de la interfaz y más)"
L["PlaceholderDesc"] = "El marcador de posición es un elemento que mantiene todos los elementos visibles de tu minimapa en su sitio mientras Farmhud está activo."
L["PlayerDot"] = "Jugador: flecha o punto"
L["PlayerDotDesc"] = "Cambia el aspecto del jugador cuando FarmHud esté abierto en punto o flecha"
L["PleaseReportThisMessage"] = "Por favor reporte este mensaje en Curseforge Issues (problemas) de FarmHud como Screenshots o texto."
L["QuestArrow"] = "Flecha de misión"
L["QuestArrowDesc"] = "Mostrar flecha de misión en el HUD abierto"
L["QuestArrowHide"] = "Ocultar la flecha de misión en el HUD abierto"
L["QuestArrowInfoMsg"] = "Mensaje informativo"
L["QuestArrowInfoMsgDesc"] = "Mostrar mensaje de información en la ventana de chat general"
L["QuestArrowInfoMsgDisabled"] = "Seguimiento de la misión desactivado"
L["QuestArrowInfoMsgRestored"] = "Restablecido el seguimiento de las misiones"
L["RangeCircles"] = "Círculos de referencia"
L["ResetColor"] = "Restablecer color"
L["Rotation"] = "Rotación"
L["RotationDesc"] = "Forzar la rotación del minimapa en modo HUD"
L["S"] = "Short version of cardinal point \"Sur\""
L["SE"] = "Short version of cardinal point \"Sureste\""
L["ShowPlaceholder"] = "Mostrar elementos"
L["ShowPlaceholderBg"] = "Mostrar fondo"
L["ShowPlaceholderBgDesc"] = "Muestra un fondo negro en lugar del minimapa mientras FarmHud está activo."
L["ShowPlaceholderDesc"] = "Los elementos de su minimapa permanecen visibles incluso cuando FarmHud está activo."
L["SupportBlizzard"] = "Blizzard ha realizado algunos cambios que hacen inútil ofrecer soporte opcional de addons individuales o librerías."
L["SupportHereBeDragon"] = "Tomtom y HandyNotes son compatibles a través de la biblioteca HereBeDragon, pero HandyNotes tienen un problema con la conmutación Hud. Todos los iconos alrededor de su posición desaparecerán al cambiar a FarmHud. Con tan solo moverse un poco caminar/volar alrededor debería mostrarse de nuevo."
L["SupportOptions"] = "Opciones de ayuda"
L["SW"] = "Short version of cardinal point \"Suroeste\""
L["TextScale"] = "Tamaño de fuente"
L["TextScaleDesc"] = "Tamaño de fuente en el HUD para puntos cardinales, cursor activo y coordenadas."
L["Time"] = "Hora local/servidor"
L["TimeBottom"] = "Hora en la parte inferior"
L["TimeBottomDesc"] = "Muestra la hora en la parte inferior"
L["TimeColorDesc"] = "Ajustar el color de la hora"
L["TimeColorResetDesc"] = "Restablecer el color de la hora"
L["TimeLocal"] = "Hora local"
L["TimeLocalDesc"] = "Muestra la hora local."
L["TimeServer"] = "Hora servidor"
L["TimeServerDesc"] = "Muestra la hora del servidor."
L["TimeShow"] = "Muestra la hora"
L["TimeShowDesc"] = "Mostrar la hora local o del servidor en el modo HUD"
L["TrackingOptions"] = "Opciones de seguimiento"
L["TrackingOptionsDesc"] = "Alternar iconos de seguimiento con FarmHud abierto.|n|n\"Como el minimapa\" significa que sus ajustes/cambios sobre el botón en el minimapa se usarán en FarmHud este abierto."
L["TrackingOptionsLikeMinimap"] = "Como el minimapa"
L["TrailPath"] = "Recorrido"
L["TrailPathColorsDesc"] = "Ajusta el color de los iconos de tu recorrido."
L["TrailPathCount"] = "Número de puntos"
L["TrailPathCountDesc"] = "Ajusta la cantidad máxima de puntos de recorrido que se muestra en el minimapa/farmhud."
L["TrailPathIcon"] = "Icono"
L["TrailPathIconDesc"] = "Elige un icono para tu recorrido."
L["TrailPathOnMinimap"] = "Mostrar en minimapa"
L["TrailPathOnMinimapDesc"] = "Muestra la ruta del recorrido también en el minimapa."
L["TrailPathScale"] = "Tamaño de los iconos"
L["TrailPathScaleDesc"] = "Ajusta el tamaño de los iconos de tu recorrido."
L["TrailPathShow"] = "Mostrar recorrido"
L["TrailPathTimeout"] = "Desvanecimiento (seg.)"
L["TrailPathTimeoutDesc"] = "Ajusta el tiempo tras el cual tu recorrido se elimina del minimapa/farmhud."
L["W"] = "Short version of cardinal point \"Oeste\" "
L["White player dot"] = "Punto de jugador blanco"
